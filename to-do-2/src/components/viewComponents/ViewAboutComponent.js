...
const ViewAboutComponent = () =>(
    <div className="container">
        ...
        I had never work with a one-page library/framework before this proyect. So after watching <a href="https://youtu.be/-9ic_5Xggww">this video</a>, I came to these conclusions
            <ul>
                <li>Vue was discarded because wasn't even in the options that were given to me</li> 
        ...
        <p>
            Finally, the database is in <a href="https://www.mongodb.com/">MongoDB</a>, and the app you're looking running ISN'T in <a href="https://dashboard.heroku.com/">Heroku yet</a>
        </p>
        ...
        <h2>Want the code?</h2>
        <p>
            No problem! Here it is on <a href="https://github.com/franBec/toDoApp">github</a>
        </p>
